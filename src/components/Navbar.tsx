      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center">
            <img src={logo} alt="Pasticeri Lika" className="h-12 w-60" />
            {/* <Cake className="h-8 w-8 text-rose-600" />
            <span className="ml-2 text-2xl font-serif font-bold text-gray-900">
              Pasticeri Lika
            </span> */}
          </Link>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <Link
                to="/products"
                className={`${
                  isActive("/products") ? "text-rose-600" : "text-gray-900"
                } hover:text-rose-600 transition-colors`}>
                Our Products
              </Link>
              <Link
                to="/gallery"
                className={`${
                  isActive("/gallery") ? "text-rose-600" : "text-gray-900"
                } hover:text-rose-600 transition-colors`}>
                Gallery
              </Link>
              <Link
                to="/bar-menu"
                className={`${
                  isActive("/bar-menu") ? "text-rose-600" : "text-gray-900"
                } hover:text-rose-600 transition-colors`}>
                Bar Menu
              </Link>
              <Link
                to="/about"
                className={`${
                  isActive("/about") ? "text-rose-600" : "text-gray-900"
                } hover:text-rose-600 transition-colors`}>
                About
              </Link>
              <Link
                to="/contact"
                className={`${
                  isActive("/contact") ? "text-rose-600" : "text-gray-900"
                } hover:text-rose-600 transition-colors`}>
                Contact
              </Link>
